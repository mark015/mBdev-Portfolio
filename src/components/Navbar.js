        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div>
            <a href="#" className="flex items-center text-black text-2xl font-bold">
              <img src={mbdev} alt="Logo" className="h-10 w-30 mr-2" />
            </a>
          </div>
          ...
          <div className="flex items-center space-x-3 md:space-x-6">
            <div className="md:flex flex items-center space-x-3">
              <a href="mailto:your.email@example.com" className="py-2 px-4 flex font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 icon-text-link transition duration-300">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
              ...
              <a href={cv} target="_blank" className="icon-text-link py-2 px-4 font-medium text-white flex bg-blue-700 rounded-lg hover:bg-blue-800 transition duration-300">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
